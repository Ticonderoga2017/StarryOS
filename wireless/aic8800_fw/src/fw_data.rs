...
//! 路径相对于本文件 (wireless/aic8800_fw/src/fw_data.rs)，  
//! 即 ../firmware/ 指向 StarryOS/wireless/aic8800_fw/firmware/  
//! 
//! 运行时通过 get_firmware_set() 根据芯片型号和版本选择正确的固件组合。 

use crate::chip_id::{ChipVariant, ChipRevision, CHIP_REV_U01, CHIP_REV_U02}; 
...
pub static FW_DC_PATCH_TBL: &[u8] = include_bytes!("../firmware/fw_patch_table_8800dc_u02.bin");
...
pub static FW_D80_PATCH_TBL: &[u8] = include_bytes!("../firmware/fw_patch_table_8800d80_u02.bin");
...
pub static FW_D80X2_PATCH_TBL: &[u8] = include_bytes!("../firmware/fw_patch_table_8800d80_u02.bin");
...
pub fn get_firmware_set(chip: ChipVariant, rev: &ChipRevision) -> Option<FirmwareSet> {  
    match chip {
        // ---- AIC8801 ----  
        ChipVariant::Aic8801 => {
            Some(FirmwareSet {
